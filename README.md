...
- `characters`：`user_id`, `title`, `sect_name`, `sect_branch`, `realm`, `cultivation`, `cultivation_cap`, `spiritual_root`, `age`, `lifespan`, `hp`, `mana`, `attack`, `defense`, `inner_demon`, `luck`, `spirit_stones`, `action_points`, `max_action_points`, `action_spent_total`, `age_progress`, `last_action_recovered_at`
