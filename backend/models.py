...
class Character(Base):
    ...
    cultivation_method_attack_bonus: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    cultivation_method_defense_bonus: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    cultivation_method_mana_bonus: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    magic_treasure_attack_bonus: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    magic_treasure_defense_bonus: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    magic_treasure_mana_bonus: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
